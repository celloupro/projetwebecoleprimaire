package gn.diallotelly.projet.web.ecole.primaire.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        gn.diallotelly.projet.web.ecole.primaire.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(
        gn.diallotelly.projet.web.ecole.primaire.service.UsernameAlreadyUsedException ex,
        NativeWebRequest request
    ) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        gn.diallotelly.projet.web.ecole.primaire.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
